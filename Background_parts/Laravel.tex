...
Il \textit{Service Container} si occupa di gestire le dipendenze delle classi e di eseguire le iniezioni delle dipendenze (\textit{Dependency Injection}, DI).
